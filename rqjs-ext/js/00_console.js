...
var primordials = {
  ...
  RegExpPrototypeSymbolReplace: (that, ...args) => RegExp.prototype[Symbol.replace].call(that, ...args),
  ...
  ObjectPrototypeIsPrototypeOf: (that, ...args) => Object.prototype.isPrototypeOf.call(that, ...args),
  ObjectPrototypePropertyIsEnumerable: (that, ...args) => Object.prototype.propertyIsEnumerable.call(that, ...args),
  ObjectPrototypeToString: (that, ...args) => Object.prototype.toString.call(that, ...args),
  ObjectAssign: (...args) => Object.assign(...args),
  ObjectGetOwnPropertyDescriptor: (...args) => Object.getOwnPropertyDescriptor(...args),
  ObjectGetOwnPropertyNames: (...args) => Object.getOwnPropertyNames(...args),
  ObjectGetOwnPropertySymbols: (...args) => Object.getOwnPropertySymbols(...args),
  ...
  FunctionPrototypeBind: (that, ...args) => Function.prototype.bind.call(that, ...args),
  FunctionPrototypeCall: (that, ...args) => Function.prototype.call.call(that, ...args),
  FunctionPrototypeToString: (that, ...args) => Function.prototype.toString.call(that, ...args),
  Array,
  ArrayPrototypeFill: (that, ...args) => Array.prototype.fill.call(that, ...args),
  ArrayPrototypeFind: (that, ...args) => Array.prototype.find.call(that, ...args),
  ArrayPrototypePop: (that, ...args) => Array.prototype.pop.call(that, ...args),
  ArrayPrototypePush: (that, ...args) => Array.prototype.push.call(that, ...args),
  ArrayPrototypeShift: (that, ...args) => Array.prototype.shift.call(that, ...args),
  ArrayPrototypeUnshift: (that, ...args) => Array.prototype.unshift.call(that, ...args),
  ArrayPrototypeSlice: (that, ...args) => Array.prototype.slice.call(that, ...args),
  ArrayPrototypeSort: (that, ...args) => Array.prototype.sort.call(that, ...args),
  ArrayPrototypeSplice: (that, ...args) => Array.prototype.splice.call(that, ...args),
  ArrayPrototypeIncludes: (that, ...args) => Array.prototype.includes.call(that, ...args),
  ArrayPrototypeJoin: (that, ...args) => Array.prototype.join.call(that, ...args),
  ArrayPrototypeForEach: (that, ...args) => Array.prototype.forEach.call(that, ...args),
  ArrayPrototypeFilter: (that, ...args) => Array.prototype.filter.call(that, ...args),
  ArrayPrototypeMap: (that, ...args) => Array.prototype.map.call(that, ...args),
  ArrayPrototypeReduce: (that, ...args) => Array.prototype.reduce.call(that, ...args),
  ArrayIsArray: (...args) => Array.isArray(...args),
  Number,
  NumberPrototypeToString: (that, ...args) => Number.prototype.toString.call(that, ...args),
  NumberPrototypeValueOf: (that, ...args) => Number.prototype.valueOf.call(that, ...args),
  NumberIsInteger: (...args) => Number.isInteger(...args),
  NumberParseInt: (...args) => Number.parseInt(...args),
  Boolean,
  BooleanPrototypeValueOf: (that, ...args) => Boolean.prototype.valueOf.call(that, ...args),
  String,
  StringPrototypeCharCodeAt: (that, ...args) => String.prototype.charCodeAt.call(that, ...args),
  StringPrototypeCodePointAt: (that, ...args) => String.prototype.codePointAt.call(that, ...args),
  StringPrototypeEndsWith: (that, ...args) => String.prototype.endsWith.call(that, ...args),
  StringPrototypeIncludes: (that, ...args) => String.prototype.includes.call(that, ...args),
  StringPrototypeIndexOf: (that, ...args) => String.prototype.indexOf.call(that, ...args),
  StringPrototypeLastIndexOf: (that, ...args) => String.prototype.lastIndexOf.call(that, ...args),
  StringPrototypeMatch: (that, ...args) => String.prototype.match.call(that, ...args),
  StringPrototypeNormalize: (that, ...args) => String.prototype.normalize.call(that, ...args),
  StringPrototypePadEnd: (that, ...args) => String.prototype.padEnd.call(that, ...args),
  StringPrototypePadStart: (that, ...args) => String.prototype.padStart.call(that, ...args),
  StringPrototypeRepeat: (that, ...args) => String.prototype.repeat.call(that, ...args),
  StringPrototypeReplace: (that, ...args) => String.prototype.replace.call(that, ...args),
  StringPrototypeReplaceAll: (that, ...args) => String.prototype.replaceAll.call(that, ...args),
  StringPrototypeSlice: (that, ...args) => String.prototype.slice.call(that, ...args),
  StringPrototypeSplit: (that, ...args) => String.prototype.split.call(that, ...args),
  StringPrototypeStartsWith: (that, ...args) => String.prototype.startsWith.call(that, ...args),
  StringPrototypeTrim: (that, ...args) => String.prototype.trim.call(that, ...args),
  StringPrototypeToLowerCase: (that, ...args) => String.prototype.toLowerCase.call(that, ...args),
  StringPrototypeValueOf: (that, ...args) => String.prototype.valueOf.call(that, ...args),
  Symbol,
  SymbolPrototypeToString: (that, ...args) => Symbol.prototype.toString.call(that, ...args),
  SymbolPrototypeValueOf: (that, ...args) => Symbol.prototype.valueOf.call(that, ...args),
  SymbolFor: (...args) => Symbol.for(...args),
  SymbolHasInstance: Symbol.hasInstance,
  SymbolIterator: Symbol.iterator,
  SymbolToStringTag: Symbol.toStringTag,
  DatePrototype: Date.prototype,
  DatePrototypeToISOString: (that, ...args) => Date.prototype.toISOString.call(that, ...args),
  DatePrototypeGetTime: (that, ...args) => Date.prototype.getTime.call(that, ...args),
  DateNow: (...args) => Date.now(...args),
  RegExpPrototypeExec: (that, ...args) => RegExp.prototype.exec.call(that, ...args),
  RegExpPrototypeToString: (that, ...args) => RegExp.prototype.toString.call(that, ...args),
  RegExpPrototypeTest: (that, ...args) => RegExp.prototype.test.call(that, ...args),
  Error,
  ErrorPrototype: Error.prototype,
  ErrorPrototypeToString: (that, ...args) => Error.prototype.toString.call(that, ...args),
  ...
  MapPrototypeDelete: (that, ...args) => Map.prototype.delete.call(that, ...args),
  MapPrototypeEntries: (that, ...args) => Map.prototype.entries.call(that, ...args),
  MapPrototypeForEach: (that, ...args) => Map.prototype.forEach.call(that, ...args),
  BigIntPrototypeValueOf: (that, ...args) => BigInt.prototype.valueOf.call(that, ...args),
  ...
  SetPrototypeValues: (that, ...args) => Set.prototype.values.call(that, ...args),
  WeakMapPrototypeHas: (that, ...args) => WeakMap.prototype.has.call(that, ...args),
  WeakSetPrototypeHas: (that, ...args) => WeakSet.prototype.has.call(that, ...args),
  Proxy,
  ReflectGet: (...args) => Reflect.get(...args),
  ReflectGetOwnPropertyDescriptor: (...args) => Reflect.getOwnPropertyDescriptor(...args),
  ...
  ObjectGetOwnPropertyDescriptors: (...args) => Object.getOwnPropertyDescriptors(...args),
  // TODO
...
var noColorStdout = () => false;
var noColorStderr = () => false;
...
function isAggregateError(value) {
  return isNativeError2(value) && value.name === "AggregateError" && ArrayIsArray2(value.errors);
}
var kObjectType = 0;
var kArrayType = 1;
...
var strEscapeSequencesReplacer = new SafeRegExp("[\0-'\\\x7F-\x9F]", "g");
var keyStrRegExp = new SafeRegExp("^[a-zA-Z_][a-zA-Z_0-9]*$");
var numberRegExp = new SafeRegExp("^(0|[1-9][0-9]*)$");
var escapeFn = (str) => meta[StringPrototypeCharCodeAt(str, 0)];
function stylizeNoColor(str) {
  return str;
}
var nodeCustomInspectSymbol = SymbolFor("nodejs.util.inspect.custom");
var privateCustomInspect = SymbolFor("Deno.privateCustomInspect");
function getUserOptions(ctx, isCrossContext) {
  ...
  if (isCrossContext) {
    ...
    for (const key of new SafeArrayIterator2(ObjectKeys(ret))) {
  ...
  if (ctx.customInspect) {
    if (ReflectHas(value, customInspect) && typeof value[customInspect] === "function") {
      ...
      !(value.constructor && value.constructor.prototype === value)) {
        ...
        const isCrossContext = !ObjectPrototypeIsPrototypeOf(ObjectPrototype, context);
        const ret = FunctionPrototypeCall(maybeCustom, context, depth, getUserOptions(ctx, isCrossContext), ctx.inspect);
        if (ret !== context) {
...
function getClassBase(value, constructor, tag) {
  const hasName = ObjectHasOwn2(value, "name");
...
var stripCommentsRegExp = new SafeRegExp("(\\/\\/.*?\\n)|(\\/\\*(.|\\n)*?\\*\\/)", "g");
var classRegExp = new SafeRegExp("^(\\s+[^(]*?)\\s*{");
function getFunctionBase(value, constructor, tag) {
  ...
  if (StringPrototypeStartsWith(stringified, "class") && StringPrototypeEndsWith(stringified, "}")) {
    ...
    RegExpPrototypeExec2(classRegExp, RegExpPrototypeSymbolReplace(stripCommentsRegExp, slice)) !== null)) {
...
function formatRaw(ctx, value, recurseTimes, typedArray, proxyDetails) {
  ...
  if (proxyDetails !== null && ctx.showProxy) {
    ...
    if (noIterator) {
      ...
      if (constructor === "Object") {
        ...
        base = RegExpPrototypeToString(constructor !== null ? regExp : new SafeRegExp(regExp));
        ...
        if (typedArray === void 0) {
          ...
          return prefix + `{ byteLength: ${formatNumber(ctx.stylize, TypedArrayPrototypeGetByteLength(value))} }`;
        }
        braces[0] = `${prefix}{`;
  ...
  if (ctx.sorted) {
    ...
    if (extrasType === kObjectType) {
      ...
      ArrayPrototypeSplice(output, output.length - keys.length, keys.length, ...new SafeArrayIterator2(sorted));
    }
  }
...
var builtInObjectsRegExp = new SafeRegExp("^[A-Z][a-zA-Z0-9]+$");
var builtInObjects = new SafeSet(ArrayPrototypeFilter(ObjectGetOwnPropertyNames(globalThis), (e) => RegExpPrototypeTest(builtInObjectsRegExp, e)));
function addPrototypeProperties(ctx, main, obj, recurseTimes, output) {
  ...
  do {
    ...
    for (const key of new SafeArrayIterator2(keys)) {
      if (key === "constructor" || ObjectHasOwn2(main, key) || depth !== 0 && SetPrototypeHas(keySet, key)) {
        continue;
      }
...
var formatPrimitiveRegExp = new SafeRegExp("(?<=\n)");
function formatPrimitive(fn, value, ctx) {
  if (typeof value === "string") {
    ...
    value.length > kMinLineLength && value.length > ctx.breakLength - ctx.indentationLvl - 4) {
      return ArrayPrototypeJoin(ArrayPrototypeMap(StringPrototypeSplit(value, formatPrimitiveRegExp), (line) => fn(quoteString(line, ctx), "string")), ` +
...
function getKeys(value, showHidden) {
  ...
  if (showHidden) {
    ...
    try {
      ...
      assert(isNativeError2(err) && err.name === "ReferenceError" && isModuleNamespaceObject2(value));
      keys = ObjectGetOwnPropertyNames(value);
    }
    if (symbols.length !== 0) {
...
function formatSet(value, ctx, _ignored, recurseTimes) {
  ...
  const values = [...new SafeSetIterator2(value)];
...
function formatMap(value, ctx, _ignored, recurseTimes) {
  ctx.indentationLvl += 2;
  const values = [...new SafeMapIterator2(value)];
  const valLen = MapPrototypeGetSize(value);
  const len = MathMin(MathMax(0, ctx.iterableLimit), valLen);
  const remaining = valLen - len;
  const output = [];
  for (let i = 0; i < len; i++) {
    ArrayPrototypePush(output, `${formatValue(ctx, values[i][0], recurseTimes)} => ${formatValue(ctx, values[i][1], recurseTimes)}`);
  }
  if (remaining > 0) {
    ArrayPrototypePush(output, `... ${remaining} more item${remaining > 1 ? "s" : ""}`);
  }
...
function formatTypedArray(value, length, ctx, _ignored, recurseTimes) {
  ...
  if (ctx.showHidden) {
    ctx.indentationLvl += 2;
    for (const key of new SafeArrayIterator2([
      "BYTES_PER_ELEMENT",
      "length",
      "byteLength",
      "byteOffset",
...
var iteratorRegExp = new SafeRegExp(" Iterator] {$");
function formatIterator(braces, ctx, value, recurseTimes) {
  const { 0: entries, 1: isKeyValue } = op_preview_entries(value, true);
  if (isKeyValue) {
    braces[0] = StringPrototypeReplace(braces[0], iteratorRegExp, " Entries] {");
...
var AGGREGATE_ERROR_HAS_AT_PATTERN = new SafeRegExp(/\s+at/);
var AGGREGATE_ERROR_NOT_EMPTY_LINE_PATTERN = new SafeRegExp(/^(?!\s*$)/gm);
function inspectError(value, ctx) {
  ...
  for (let i = 0; i < causes.length; ++i) {
    ...
    if (ctx.circular !== void 0) {
      ...
      if (index !== void 0) {
        MapPrototypeSet(refMap, cause, ctx.stylize(`<ref *${index}> `, "special"));
      }
    }
  }
  ...
  finalMessage += ArrayPrototypeJoin(ArrayPrototypeMap(causes, (cause) => "\nCaused by " + (MapPrototypeGet(refMap, cause) ?? "") + (cause?.stack ?? cause)), "");
  return finalMessage;
}
...
var arrayBufferRegExp = new SafeRegExp("(.{2})", "g");
function formatArrayBuffer(ctx, value) {
  ...
  let str = StringPrototypeTrim(StringPrototypeReplace(hexSlice(buffer), arrayBufferRegExp, "$1 "));
  const remaining = valLen - len;
  if (remaining > 0) {
...
var colorRegExp = new SafeRegExp("\x1B\\[\\d\\d?m", "g");
...
var ansi = new SafeRegExp(ansiPattern, "g");
function getStringWidth(str, removeControlChars = true) {
  ...
  for (const char of new SafeStringIterator2(str)) {
...
function cliTable(head, columns) {
  ...
  const columnRightAlign = ArrayPrototypeFill(new Array2(columnWidths.length), true);
...
var DEFAULT_INDENT = "  ";
var STR_ABBREVIATE_SIZE = 1e4;
var CSI = class {
  static kClear = "\x1B[1;1H";
  static kClearScreenDown = "\x1B[0J";
};
var QUOTE_SYMBOL_REG = new SafeRegExp(/^[a-zA-Z_][a-zA-Z_.0-9]*$/);
...
function quoteString(string, ctx) {
  const quote = ArrayPrototypeFind(ctx.quotes, (c) => !StringPrototypeIncludes(string, c)) ?? ctx.quotes[0];
...
var ESCAPE_PATTERN = new SafeRegExp(/([\b\f\n\r\t\v])/g);
var ESCAPE_MAP = ObjectFreeze({
  "\b": "\\b",
  "\f": "\\f",
  "\n": "\\n",
  "\r": "\\r",
...
var ESCAPE_PATTERN2 = new SafeRegExp("[\0-\x7F-\x9F]", "g");
function replaceEscapeSequences(string) {
  return StringPrototypeReplace(StringPrototypeReplace(string, ESCAPE_PATTERN, (c) => ESCAPE_MAP[c]), ESCAPE_PATTERN2, (c) => "\\x" + StringPrototypePadStart(NumberPrototypeToString(StringPrototypeCharCodeAt(c, 0), 16), 2, "0"));
}
...
var HASH_PATTERN = new SafeRegExp(/^#([\dA-Fa-f]{2})([\dA-Fa-f]{2})([\dA-Fa-f]{2})([\dA-Fa-f]{2})?$/);
var SMALL_HASH_PATTERN = new SafeRegExp(/^#([\dA-Fa-f])([\dA-Fa-f])([\dA-Fa-f])([\dA-Fa-f])?$/);
var RGB_PATTERN = new SafeRegExp(/^rgba?\(\s*([+\-]?\d*\.?\d+)\s*,\s*([+\-]?\d*\.?\d+)\s*,\s*([+\-]?\d*\.?\d+)\s*(,\s*([+\-]?\d*\.?\d+)\s*)?\)$/);
var HSL_PATTERN = new SafeRegExp(/^hsla?\(\s*([+\-]?\d*\.?\d+)\s*,\s*([+\-]?\d*\.?\d+)%\s*,\s*([+\-]?\d*\.?\d+)%\s*(,\s*([+\-]?\d*\.?\d+)\s*)?\)$/);
...
var SPACE_PATTERN = new SafeRegExp(/\s+/g);
...
function cssToAnsi(css, prevCss = null) {
  ...
  if (!colorEquals(css.backgroundColor, prevCss.backgroundColor)) {
    if (css.backgroundColor == null) {
      ...
      if (ArrayIsArray2(css.backgroundColor)) {
...
var countMap = new SafeMap();
var timerMap = new SafeMap();
var isConsoleInstance = Symbol2("isConsoleInstance");
...
var Console = class {
  ...
  log = (...args) => {
    this.#printFunc(inspectArgs(args, {
  ...
  dir = (obj = void 0, options = { __proto__: null }) => {
    this.#printFunc(inspectArgs([obj], {
      ...getConsoleInspectOptions(noColorStdout()),
      ...options
    }) + "\n", 1);
  };
  ...
  assert = (condition = false, ...args) => {
    ...
    const [first, ...rest] = new SafeArrayIterator2(args);
    if (typeof first === "string") {
      this.error(`Assertion failed: ${first}`, ...new SafeArrayIterator2(rest));
      return;
    }
    this.error(`Assertion failed:`, ...new SafeArrayIterator2(args));
  };
  count = (label = "default") => {
    label = String2(label);
  ...
  table = (data = void 0, properties = void 0) => {
    if (properties !== void 0 && !ArrayIsArray2(properties)) {
      throw new Error2("The 'properties' argument must be of type Array. Received type " + typeof properties);
    }
    ...
    if (isSetObject) {
      resultData = [...new SafeSetIterator2(data)];
    } else if (isMapObject) {
      let idx = 0;
    ...
    const objectValues = properties ? ObjectFromEntries(ArrayPrototypeMap(properties, (name) => [name, ArrayPrototypeFill(new Array2(numRows), "")])) : {};
    const indexKeys = [];
    const values = [];
    ...
    const headerProps = properties || [
      ...new SafeArrayIterator2(headerKeys),
      !isMapObject && hasPrimitives && valuesKey
    ];
    const header = ArrayPrototypeFilter([
      indexKey,
      ...new SafeArrayIterator2(headerProps)
    ], Boolean2);
    const body = [indexKeys, ...new SafeArrayIterator2(bodyValues), values];
    toTable(header, body);
  };
  time = (label = "default") => {
    label = String2(label);
  ...
  timeLog = (label = "default", ...args) => {
    ...
    this.info(`${label}: ${duration}ms`, ...new SafeArrayIterator2(args));
  };
  ...
  group = (...label) => {
    if (label.length > 0) {
      this.log(...new SafeArrayIterator2(label));
    }
    this.indentLevel += 2;
  };
...
var customInspect = SymbolFor("Deno.customInspect");
