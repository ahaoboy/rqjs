...
function getTerminalShape2() {
  const width = process3.stdout.columns;
  const height = process3.stdout.rows;
  return { width, height };
}
...
function FillBox() {
  const { width, height } = getTerminalShape2();
  ...
  return /* @__PURE__ */ import_react10.default.createElement(
    ...
    Array(width * height).fill(0).map((_, k) => {
      const x = k % width;
      const y = (k - x) / width | 0;
      const text = x + y & 1 ? " " : "\u2588";
      return /* @__PURE__ */ import_react10.default.createElement(
...
render(/* @__PURE__ */ import_react10.default.createElement(FillBox, null));
export {
  FillBox as default
};
