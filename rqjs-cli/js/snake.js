  ...
  "node_modules/.pnpm/scheduler@0.23.2/node_modules/scheduler/cjs/scheduler.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var isInputPending = false.scheduling !== void 0 && false.scheduling.isInputPending !== void 0 ? false.scheduling.isInputPending.bind(false.scheduling) : null;
...
// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/ui/box.js
var import_react = __toESM(require_react());
var import_react2 = __toESM(require_react());
var Box = (0, import_react2.forwardRef)((props, ref) => {
  return props.display !== "none" && import_react.default.createElement("tui-box", { ref, ...props });
});

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/render/reconciler.js
var import_react_reconciler = __toESM(require_react_reconciler());
var import_constants = __toESM(require_constants());

// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/ansi/ansi-regex.js
...
// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/ansi/strip-ansi.js
var regex = ansiRegex();
...
// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/ansi/ansi-length.js
...
// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/shape.js
function getStringShape(s) {
  let width = 0;
  const lines = s.split("\n");
...
// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/assert.js
...
// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/rect.js
var Rect = class _Rect {
  ...
  static fromCoord(coord) {
    return new _Rect(coord.x0, coord.y0, coord.x1 - coord.x0, coord.y1 - coord.y0);
  }
  hasPoint(x, y) {
  ...
  placeCenter(other) {
    ...
    const nx = this.x + dx;
    const ny = this.y + dy;
    return new _Rect(nx, ny, other.width, other.height);
  }
  scale(scale) {
    return new _Rect(this.x * scale, this.y * scale, this.width * scale, this.height * scale);
  }
};
...
// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/number.js
...
function assertPercentage(s) {
  assert(isPercentage(s), `not a valid percentage string: ${s}`);
}

// node_modules/.pnpm/@r-tui+share@0.1.4/node_modules/@r-tui/share/dist/color.js
var AnsiColor = {
  black: 30,
  red: 31,
  green: 32,
...
// node_modules/.pnpm/@r-tui+flex@0.1.6-alpha.0/node_modules/@r-tui/flex/dist/dom.js
var LayoutNode = class extends Rect {
  x;
  y;
  width;
  height;
  ...
  _mouseIn;
  _focus;
  constructor(x = 0, y = 0, width = 0, height = 0, padding = 0, border = 0, hide = false, textRect = new Rect(0, 0, 0, 0), computedSizeCount = 0, computedLayoutCount = 0, _hideCache = false, _renderCache = false, _mouseDown = false, _mouseUp = false, _mouseIn = false, _focus = false) {
    ...
    this.computedSizeCount = computedSizeCount;
    this.computedLayoutCount = computedLayoutCount;
    this._hideCache = _hideCache;
    this._renderCache = _renderCache;
    this._mouseDown = _mouseDown;
    this._mouseUp = _mouseUp;
    this._mouseIn = _mouseIn;
    this._focus = _focus;
  }
};
var EventNameList = [
...
function removeChildNode(node, removeNode) {
...
// node_modules/.pnpm/@r-tui+flex@0.1.6-alpha.0/node_modules/@r-tui/flex/dist/flex.js
function hasTLBR(node) {
...
function lenToNumber(node, len, isX, defaultValue = 0) {
  let v = defaultValue;
  switch (typeof len) {
    case "number": {
      v = len;
...
function skipFlexLayout(node) {
  return node.attributes.position === "absolute" || hasTLBR(node) || typeof node.attributes.x !== "undefined" || typeof node.attributes.y !== "undefined";
}
var defaultZIndexStep = 1;
function getAxisAttrSize(n, isX) {
  return isX ? n.attributes.width : n.attributes.height;
}
function getAxisPosition(n, isX) {
  return isX ? n.layoutNode.x : n.layoutNode.y;
}
function getAxisSize(n, isX) {
  return isX ? n.layoutNode.width : n.layoutNode.height;
}
function setAxisPosition(n, x, isX) {
  if (isX) {
    n.layoutNode.x = x;
  } else {
    n.layoutNode.y = x;
...
var Flex = class {
  ...
  computedNodeTLBR(node) {
    ...
    assert(!(typeof attributes.left !== "undefined" && typeof attributes.right !== "undefined"), "absolute position: do not set both left and right");
    assert(!(typeof attributes.top !== "undefined" && typeof attributes.bottom !== "undefined"), "absolute position: do not set both top and bottom");
    ...
    switch (typeof attributes.left) {
      ...
      case "string": {
        layoutNode.x = parent.layoutNode.x + parent.layoutNode.width * parsePercentage(attributes.left);
        break;
      }
      default: {
    ...
    switch (typeof attributes.right) {
      case "number": {
        layoutNode.x = parent.layoutNode.x + parent.layoutNode.width - attributes.right - layoutNode.width;
        break;
      }
      case "string": {
        layoutNode.x = parent.layoutNode.x + parent.layoutNode.width - layoutNode.width - parent.layoutNode.width * parsePercentage(attributes.right);
        break;
      }
      case "undefined": {
        break;
    ...
    switch (typeof attributes.top) {
      ...
      case "string": {
        layoutNode.y = parent.layoutNode.y + parent.layoutNode.height * parsePercentage(attributes.top);
        break;
      }
      case "undefined": {
        break;
    ...
    switch (typeof attributes.bottom) {
      case "number": {
        layoutNode.y = parent.layoutNode.y + parent.layoutNode.height - attributes.bottom - layoutNode.height;
        break;
      }
      case "string": {
        layoutNode.y = parent.layoutNode.y + parent.layoutNode.height - layoutNode.height - parent.layoutNode.height * parsePercentage(attributes.bottom);
        break;
      }
      case "undefined": {
        break;
  ...
  computeNodeSize(node, currentRenderCount, deep) {
    const { attributes, layoutNode } = node;
    ...
    const xIsAuto = xAttr === void 0 || xAttr === "auto";
    const yIsAuto = yAttr === void 0 || yAttr === "auto";
    if (typeof attributes.text === "string") {
      const { width, height } = this.customMeasureNode(node);
      layoutNode.textRect = new Rect(layoutNode.textRect.x, layoutNode.textRect.y, width, height);
      if (xIsAuto) {
  ...
  computeNodeSizeAxis(node, v, isX, extraSize) {
    if (typeof v === "number") {
    ...
    if (typeof v === "string") {
      ...
      assert(!(parentAttrLen === "auto" || parentAttrLen === void 0), "The parent of a node of relative size cannot be auto or undefined");
          ...
          case "center": {
            ...
            for (const c of flexNodes) {
              ...
              if (nextStart < nodeXPos) {
                ...
                setAxisPosition(c, yAxisStart + (maxYAxisSize - childYSize) / 2, !isX);
                xAxisStart -= childXSize;
              }
            }
            return;
  ...
  computedLayout(node, currentRenderCount) {
  ...
  renderNode(node, currentRenderCount, deep) {
  ...
  dispatchMouseEventInner(node, event, dispatchMap) {
  ...
  dispatchMouseEventForNode(node, event, dispatchMap) {
    if (!event.bubbles) {
      return;
    }
    ...
    if (node.layoutNode.hasPoint(event.x, event.y)) {
      ...
      if (layoutNode._focus && (this.customIsMouseDown(event) || this.customIsMouseUp(event))) {
...
// node_modules/.pnpm/@r-tui+flex@0.1.6-alpha.0/node_modules/@r-tui/flex/dist/common.js
var propsToSkip = {
  children: true,
  ref: true,
  key: true,
...
// node_modules/.pnpm/@r-tui+canvas@0.1.4/node_modules/@r-tui/canvas/dist/index.js
var Pixel = class {
  char;
  x;
  y;
  ...
  backgroundColor;
  bold;
  constructor(char = "", x = 0, y = 0, zIndex = 0, color, backgroundColor, bold = false) {
    this.char = char;
    this.x = x;
    this.y = y;
    this.zIndex = zIndex;
  ...
  toAnsi() {
    let s = "";
    if (!this.char.length && (this.backgroundColor === "default" || this.backgroundColor === void 0)) {
      return s;
    }
...
var Canvas = class {
  ...
  constructor(shape) {
    this.shape = shape;
    this.pixels = new Array(shape.height).fill(0).map(() => new Array(shape.width).fill(0).map(() => new Array()));
  }
  clear() {
    this.pixels = new Array(this.shape.height).fill(0).map(() => new Array(this.shape.width).fill(0).map(() => new Array()));
  }
  setPixel(x, y, pixel) {
...
// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/render/canvas.js
function drawNode(canvas, node, x, y) {
  let px = x;
  let py = y;
  ...
  for (const c of node.attributes.text || "") {
    ...
    const p = new Pixel(c, px, py, node.attributes.zIndex, node.attributes.color, node.attributes.backgroundColor);
...
// node_modules/.pnpm/@r-tui+terminal@0.1.4/node_modules/@r-tui/terminal/dist/index.js
import process2 from "node:process";
function getTerminalShape() {
  const width = process2.stdout.columns;
  const height = process2.stdout.rows;
  return { width, height };
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/render/flex.js
var BoxName = "@r-tui/box";
var RootName = "@r-tui/root";
var DefaultFps = 30;
function createTDom(nodeName = BoxName) {
  return {
    attributes: {},
...
var TFlex = class extends Flex {
  customCreateMouseEvent(node, x, y, hover, event) {
  ...
  renderToConsole = throttle_default(() => {
    console.clear();
    this.canvas.clear();
    this.rerender();
  ...
  customIsRootNode(node) {
    return node.props?.nodeName === RootName;
  }
  customCreateNode() {
    return createTDom();
  }
  customCreateRootNode() {
    return createTDom(RootName);
  }
  customRenderNode(node, currentRenderCount, deep) {
    const { props: { nodeName } = {} } = node;
  ...
  customMeasureNode(node) {
    const text = node.attributes.text || "";
    return getStringShape(text);
  }
  customComputeZIndex(node, zIndex, currentRenderCount, deep) {
  }
};

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/render/reconciler.js
var NO_CONTEXT = {};
function createCustomReconciler(flex) {
  return (0, import_react_reconciler.default)({
    supportsMutation: true,
    supportsPersistence: false,
    appendChildToContainer(root2, node) {
      appendChildNode(root2, node);
    ...
    removeChildFromContainer(root2, node) {
      removeChildNode(root2, node);
      flex.renderToConsole();
    },
    createInstance: (originalType, props, rootContainer, hostContext, internalHandle) => {
...
function render(reactNode, flex = new TFlex()) {
  const reconciler = createCustomReconciler(flex);
  const container = reconciler.createContainer(flex.rootNode, 0, null, false, null, "", (e) => {
    throw e;
  }, null);
  let lastW = 0;
  let lastH = 0;
...
// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/snake.js
var import_react4 = __toESM(require_react());

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/hook/input.js
var import_react3 = __toESM(require_react());
var init = false;
var inputHandleSet = /* @__PURE__ */ new Set();
var CtrlC = "";
var Left = "\x1B[D";
var Up = "\x1B[A";
var Right = "\x1B[C";
...
function SnakeGame() {
  ...
  const [body, setBody] = (0, import_react4.useState)(snake.body);
  const [food, setFood] = (0, import_react4.useState)({ x: -1, y: -1 });
  const cellSize = 1;
  ...
  const updateRef = (0, import_react4.useRef)(update);
  ...
  return import_react4.default.createElement(Box, { position: "relative", width: "100%", height: "100%", backgroundColor: "default", alignItems: "center" }, Array(xCount * yCount).fill(0).map((_, k) => {
    const x = k % xCount;
    const y = k / xCount | 0;
    let color = "default";
    if (body.length) {
    ...
    return import_react4.default.createElement(Box, { position: "absolute", x: x * cellSize + offsetX, y: y * cellSize, key: k, color, zIndex: 10, text: color === "default" ? "" : "\u2588" });
  }));
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/flex.js
var import_react5 = __toESM(require_react());
function App() {
  return import_react5.default.createElement(
    Box,
    { width: "100%", height: "100%", display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" },
    import_react5.default.createElement(Box, { color: "red", text: "hello" }),
    import_react5.default.createElement(Box, { color: "green", text: "\u2665" }),
    import_react5.default.createElement(Box, { color: "blue", text: "world" })
  );
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/move-box.js
var import_react6 = __toESM(require_react());
function App2() {
  const [x, setX] = (0, import_react6.useState)(0);
  const [y, setY] = (0, import_react6.useState)(0);
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(Box, { position: "absolute", left: x, top: y, color: "red", text: "\u2588" })
  );
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/counter.js
...
function App3() {
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement(Box, { color: "red", text: "count" }),
    import_react7.default.createElement(Box, { color: "green", text: ":" }),
    import_react7.default.createElement(Box, { color: "blue", text: `${count}` })
  );
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/base.js
var import_react8 = __toESM(require_react());
function App4() {
  return import_react8.default.createElement(Box, { color: "green", text: "hello" });
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/life.js
...
function getCells(width, height, fill) {
  const v = new Array(height).fill(0).map(() => new Array(width).fill(0).map(fill));
  return v;
}
function Life() {
  const { width, height } = getTerminalShape();
  const [cells, setCells] = (0, import_react9.useState)(getCells(width, height, () => Math.random() > 0.9));
  const h = (0, import_react9.useRef)();
  h.current = () => {
  ...
  (0, import_react9.useEffect)(() => {
    setInterval(() => h.current?.(), 1e3);
  }, []);
  return import_react9.default.createElement(Box, { width, height }, new Array(width * height).fill(0).map((_, k) => {
    const x = k % width;
    const y = (k - x) / width;
    const char = cells[y][x] ? "\u2588" : "";
    return import_react9.default.createElement(Box, { position: "absolute", x, y, key: k, text: char });
  }));
}

// node_modules/.pnpm/@r-tui+ui@0.1.5-alpha.1/node_modules/@r-tui/ui/dist/examples/index.js
var Example = {
  Snake: SnakeGame,
  Flex: App,
  MoveBox: App2,
...
// script/snake.tsx
render(/* @__PURE__ */ import_react10.default.createElement(Example.Snake, null));
