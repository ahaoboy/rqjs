...
var level = (() => {
  if (false.userAgentData) {
    const brand = false.userAgentData.brands.find(({ brand: brand2 }) => brand2 === "Chromium");
    if (brand && brand.version > 93) {
      return 3;
    }
  }
  if (/\b(Chrome|Chromium)\//.test(false.userAgent)) {
    return 1;
  }
  return 0;
})();
...
// script/chalk.ts
console.log(source_default.blue("Hello"));
console.log("\x1B[1mworld\x1B[0m");
